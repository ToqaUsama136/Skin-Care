...
const OfferAndGuide = () => {
    ...
    <section className="relative flex items-center justify-center  md:py-[50px] px-4 sm:px-[20px]  ">
         <div className='relative w-full  max-w-[1280px]  bg-gradient-to-r from-[#7E1B5C] via-[#1310A6] to-[#D1068C]'>
         <article className="flex flex-col items-center justify-center text-center">
        <header className="Text mx-auto w-full max-w-[967px] max-h-[121px] m-[15px] text-[#FFFFFF] ">
        ...
        <Buttons className='bg-[#FFFFFF] px-[30px]  m-[15px]  md:w-[280px] whitespace-nowrap'>Shop the Sale</Buttons>
    ...
    <section className="relative flex items-center justify-center  pt-[50px] md:pb-[100px]  px-4">
         ...
         <div className='flex flex-col justify-between w-full md:w-1/2 px-4 md:px-10 py-8'>
            <h2 className=' h-[50px] font-DM text-[27px] md:text-[47px]  '>Your Guide to Radiant Skin</h2>
            ...
            <Buttons className='bg-white md:w-[371.66px]  '>Read More Blog Post</Buttons>
            
         </div>
         </div>

         <figure className='flex w-full  md:w-1/2  justify-center  overflow-hidden mt-8 md:mt-0 px-2 md:px-0'>
